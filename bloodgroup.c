...
{ char Name[70], G[5], answer[10];
  ...
  do
  {
    ...
    do
    {
      printf("What is your blood groupaaa [A, B, AB, or O]? ");
      scanf("%s", G);
      ...
      if (strcmp(G, "A") !=0  &&
                            ...
                            strcmp(G, "AB") !=0   &&
                            strcmp(G, "O") !=0 )
        printf("Blood group %s is incorrect! Please try againxx.\n", G);
    }  while (strcmp(G, "A") !=0  &&
                            strcmp(G, "B") !=0  &&
                            strcmp(G, "AB") !=0   &&
                            strcmp(G, "O") !=0 );
    ...
    {
      printf("%s, AB. Oh my God,sss you can give blood only to: AB.\n", Name);
